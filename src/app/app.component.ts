...
export class AppComponent {
  public appPages = [
    ...
    { title: 'Documentos Uteis', url: '/documentos-uteis', icon: 'document' },
    { title: 'Notícias', url: '/noticias', icon: 'document' },
    { title: 'Perguntas', url: '/perguntas', icon: 'help' },
    { title: 'Horário Atendimento', url: '/horario', icon: 'time' },
    { title: 'Diário Eletronico', url: '/diario-eletronico', icon: 'book' },
